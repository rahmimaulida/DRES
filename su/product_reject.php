          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $query=mysql_query("SELECT no_ticket, insertDate, sector, insertedBy, SUM(qty) as total, SUM(amount) as amount, action FROM tbl_prod_reject WHERE PIC = '".$_SESSION['name']."' GROUP BY no_ticket") or die(mysql_error());
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body" style="text-align: center">
                    ...
                    <a class="btn btn-danger btn-ok"><i class="fa fa-trash"></i> Propose Delete</a>
