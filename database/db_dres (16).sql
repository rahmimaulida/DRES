...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2018 at 12:47 PM
...
CREATE TABLE `tbl_notif` (
  ...
  `notifikasi` text COLLATE latin1_general_ci NOT NULL,
...
(1, '000000000000059641', '8 TEMPERATURE SENSOR MODULE MET148-2', 1, 'PEL', 'DRIVE', 'ATS22', 'fdgdfgfd', 0, 'OPEN', 'Not Yet Approved', 'Putra Halim', 'habib', '2018-09-07');
...
--
ALTER TABLE `tbl_history`
  MODIFY `id_history` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;
--
...
--
ALTER TABLE `tbl_prod_reject`
  MODIFY `id_reject` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
