...
$sector=mysql_query("SELECT sector FROM tbl_users WHERE userId='".$_SESSION['username']."'");
$res=mysql_fetch_array($sector);
?>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $query=mysql_query("SELECT no_ticket, insertDate, sector, insertedBy, SUM(qty) as total, SUM(amount) as amount, action FROM tbl_prod_reject WHERE sector='".$res['sector']."' GROUP BY no_ticket") or die(mysql_error());
